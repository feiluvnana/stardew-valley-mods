...
In vanilla, artisan machines strip all star quality (Silver, Gold, Iridium) from input items. BetterIndustry brings the **exact 40/30/20/10 culinary distribution system** to all artisan machines, making crop star levels directly reward higher-tier artisan goods.

### 🎲 Quality Probability Distribution Table

| Input Item Quality | Normal (0⭐) | Silver (1⭐) | Gold (2⭐) | Iridium (4⭐) | Primary Outcome |
| :--- | :---: | :---: | :---: | :---: | :--- |
| **Regular (0⭐)** | **40%** | **30%** | **20%** | **10%** | 40% Regular, chance of higher tiers |
| **Silver (1⭐)** | **30%** | **40%** | **20%** | **10%** | 40% Silver primary tier |
| **Gold (2⭐)** | **30%** | **20%** | **40%** | **10%** | 40% Gold primary tier |
| **Iridium (4⭐)** | **30%** | **20%** | **10%** | **40%** | **40% Instant Iridium Masterpiece** |
...
| **Artisan** | `EnableMachineQuality` | `true` | bool | Enables balanced 40/30/20/10 probability matrix for artisan machines. |
