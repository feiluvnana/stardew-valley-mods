# 💎 BetterGeodeCracking (Stardew Valley 1.6+)

A lightweight, high-performance quality-of-life mod for **Stardew Valley 1.6+** that introduces bulk and instant geode/trove cracking at Clint's Blacksmith shop, completely free of charge (0g fee), with full GMCM support.
...
- **📦 Supports All Geode Items**:
  ...
  - Artifact Troves
  - Golden Coconuts (with proper island first-time discovery note handling)
  - Mystery Boxes & Golden Mystery Boxes (with 1.6 mastery and book progression)
  - Any custom modded geodes
- **🎯 100% Faithful Vanilla RNG**: Follows the exact Stardew Valley 1.6 drop formulas and seed progression so achievements, statistics, and item drops remain legitimate.
- **🛡️ Safe Inventory Management**: All cracked treasures are consolidated and inserted into your inventory. If your inventory fills up, overflow items are safely dropped on the floor as debris near Clint's anvil.
- **⚙️ In-Game Configuration**: Full Generic Mod Config Menu (GMCM) support.
...
## 📄 License & Credits
Created by **feiluvnana** for Stardew Valley 1.6+.
