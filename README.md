...
| [**🏭 BetterIndustry**](./BetterIndustry) | `2.2.0` | Artisan goods and cooking rebalance suite. | Food quality & star levels (Silver, Gold, Iridium), balanced machine quality matrix (15% off-tier odds), flower mead 2.0x value scaling, Truffle Oil scaling fix, vegetable juice buffs, expanded cask aging, and profitable cooking (+25%). |
