...
| [**🏭 BetterIndustry**](./BetterIndustry) | `2.1.0` | Artisan goods and cooking rebalance suite. | Food quality & star levels (Silver, Gold, Iridium), quality-preserving machines, flower mead 2.0x value scaling, Truffle Oil scaling fix, vegetable juice buffs, expanded cask aging, and profitable cooking (+25%). |
| [**📦 BetterQOL**](./BetterQOL) | `1.4.6` | Quality-of-life suite for UI hover overlays, lookup, item stacking, and geodes. | UI Info Suite 2 style hover tooltips (crop timers, machine countdowns, tree stages, animal hearts), Lookup Anything (`F1`), unstackable item overrides up to 999, and instant "Crack All" geode processing. |
