...
| [**🏭 BetterIndustry**](./BetterIndustry) | `2.6.0` | Artisan goods, artisanal milling, cooking, fruit trees, minerals, and forestry rebalance. | Food quality & star levels (Silver, Gold), 60/25/15 deterministic machine quality matrix (0% Iridium), normalized Truffle Oil (1,967g Gold Artisan) and Flower Mead (1.35x), Cooking Oil Artisan tag (-26), guaranteed Year-1 positive fruit tree ROI, full 41 geode mineral & foraged mineral rebalance, mid/late monster loot rebalance, tree tapper multi-yields (2x/3x), and profitable cooking (+25%). |
| [**🦆 BetterAnimal**](./BetterAnimal) | `1.1.0` | Animal husbandry and small livestock productivity suite (pure multi-product & cycle scaling). | Eliminates Duck Feather penalty with high-friendship dual drops (feather + egg), halves rabbit production cooldown to 2 days, 3-day Dinosaur egg laying cycle with multi-egg clutches, 35% double Goat milk harvests, 25% double Void egg drops, daily sheep shearing, normalized Loom Down Cloth (1,050g Iridium Artisan), and 6-ball Slime Hutch scaling. |
